          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
              <button
                ...
                className="bg-black text-white px-6 md:px-8 py-3 md:py-4 rounded-full font-bold text-base md:text-lg hover:bg-gray-800 transition-all duration-300 transform hover:scale-105"
              >
